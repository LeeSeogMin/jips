...
class TopicEvaluatorLLM(BaseLLMEvaluator):
    def __init__(self, model="gpt-4.1", temperature: float = 0.0, prompt_variant: str = 'standard'):
...
def main():
    try:
        ...
        # Save results
        with open(os.path.join(data_dir, 'openai_evaluation_results.pkl'), 'wb') as f:
